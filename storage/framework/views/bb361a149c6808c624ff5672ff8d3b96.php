...
<!--Home section-->
<section class="home" id="home" style="background-image:url(assets/images/back.png)">
	<div class="home-text">
		<h1>Play!<br><span style="color: #8367AB;">CODE!</span></h1>
			<p>Gamified Coding Platform for Everyone!</p>
			<a href="#" class="start-btn"><img src="assets/images/start.svg"></a>
	</div>
</section>
...
<div class="content">
        ...
        <p>hahahahaha</p> 
        <a href="#" class="tutor-btn"><img src="assets/images/playbtn.svg" width="150px" height="20%"></a>
</div> 
        </div>
...
<footer>
    <div class=foot>
        <div>
            <ul class="contact">
            <li><a href="#"><img src="assets/images/logo.svg" style="width: 200; height: 30px; align-content: center;"></a></li>
    ...
    <div class="socials">
            ...
            <ul class="socmed">
                <li>follow us on:</li>
                <li><a href="#"><img src="assets/images/fb.svg" style="width: 200; height: 30px; align-content: center;"></img></a></li>
                <li><a href="#"><img src="assets/images/insta.svg" style="width: 200; height: 30px; align-content: center;"></img></a></li>
                <li><a href="#"><img src="assets/images/gmail.svg" style="width: 200; height: 30px; align-content: center;"></img></a></li>
            </ul>
...
</html><?php /**PATH C:\xampp\htdocs\Learn2code\resources\views/frontend/landing.blade.php ENDPATH**/ ?>